...
exports.validateDeleteInvitation = void 0;
...
exports.validateDeleteInvitation = [
    (0, verifyToken_1.default)(),
    (0, userAuth_1.default)(),
    (0, express_validator_1.param)('invitationId').notEmpty()
];
const checkIsSender = (user, invitation) => {
...
const deleteInvitation = () => {
    return (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield prisma_1.default.invitation.delete({
            where: { id: req.params.invitationId }
        });
