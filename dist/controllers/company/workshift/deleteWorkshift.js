...
exports.validateDeleteWorkshift = void 0;
...
exports.validateDeleteWorkshift = [
...
const deleteWorkshift = () => {
    return (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield prisma_1.default.workshift.delete({ where: { id: req.params.workshiftId } });
        res.json((0, response_1.default)('success', { workshift }));
    });
};
exports.default = deleteWorkshift;
